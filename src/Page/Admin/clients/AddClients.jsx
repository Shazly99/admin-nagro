...
const AddClients = () => {
    ...
    const items = [
        ...
        { label: <Link to={'/clients/add'} className='bg-orange-100 p-2 border-round'>{isLang === "en" ? "Add clients  " : 'إضافه عميل جديد'}   </Link> }
    ];
            ...
            <form onSubmit={formik.handleSubmit} className='mt-6 w-11  m-auto my-8'>
                ...
                <div className="grid  mt-5  ">
                    <div className="lg:col-6 md:col-12 sm:col-12 mt-2 input__Col ">
                        <label htmlFor="title_en" className="font-bold block mb-2">   {isLang === "en" ? "Name en" : 'الاسم بالانجليزي'}      </label>
                        <InputText name='title_en' id="title_en" type="text" className="w-full  p-inputtext-sm" onChange={formik.handleChange}
                            onBlur={formik.handleBlur} />
                    </div>
                    <div className="lg:col-6 md:col-12 sm:col-12   mt-2 input__Col" >
                        <label htmlFor="title_ar" className="font-bold block mb-2">   {isLang === "en" ? "Name ar" : 'الاسم بالعربي '} </label>
