...
const AddContributors = () => {
  ...
  const items = [
      ...
      { label: <Link to={'/contributors/add'} className='bg-orange-100 p-2 border-round'>{isLang === "en" ? "Add contributor  " : 'إضافة مساهم'}   </Link> }
  ];
          ...
          <form onSubmit={formik.handleSubmit} className='mt-6 w-11  m-auto my-8'>
              ...
              <div className="grid  mt-5  ">
                  <div className="lg:col-6 md:col-12 sm:col-12 mt-2 input__Col ">
                      ...
                      <InputText name='name' id="name" type="text" className="w-full  p-inputtext-sm" onChange={formik.handleChange}
                          onBlur={formik.handleBlur} />
                  </div>
                  <div className="lg:col-6 md:col-12 sm:col-12   mt-2 input__Col" >
                      <label htmlFor="experience" className="font-bold block mb-2">{isLang === "en" ? "Experience" : 'خبرة'}</label>
                      <InputText name='experience' id="experience" type="text" className="w-full  p-inputtext-sm" dir='rtl' onChange={formik.handleChange}
                          onBlur={formik.handleBlur} />
                  </div>
              </div>
