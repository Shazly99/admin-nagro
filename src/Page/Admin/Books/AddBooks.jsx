...
const AddBooks = () => {
  ...
  const items = [
    ...
    { label: <Link to={'/books/add'} className='bg-orange-100 p-2 border-round'>{isLang === "en" ? "Add books" : 'إضافة مقاله'}   </Link> }
  ];
            ...
            <div className="mt-3 flex justify-content-center m-auto" style={{ position: 'relative', marginBottom: '30px', width: 'fit-content' }}>
              {selectMultiImageFile ? (
                ...
                <img
                  ...
                  alt={'default-image'}
                  className='rounded-circle mx-auto'
                  style={{ border: '6px solid #fff', width: '300px', maxHeight: '172px' }}
                />
              )}
